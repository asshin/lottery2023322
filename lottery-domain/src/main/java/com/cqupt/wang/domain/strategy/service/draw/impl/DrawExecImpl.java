package com.cqupt.wang.domain.strategy.service.draw.impl;
...
import com.cqupt.wang.domain.strategy.service.draw.AbstractDrawBase;
...
public class DrawExecImpl extends AbstractDrawBase {
    ...
    @Override
    public List<String> queryAwardExcludes(Long StrategyId) {
        List<String> excludes = strategyRepository.queryNoStockStrategyAwardList(StrategyId);
        return excludes;
    }

    @Override
    public String drawStrategyAlgorithm(Long strategyId, IDrawAlgorithm drawAlgorithm, List<String> excludeAwardIds) {
        // 执行抽奖
