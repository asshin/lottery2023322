package com.cqupt.wang.domain.activity.service.partake.impl;
...
import com.cqupt.wang.domain.activity.repository.IUserTakeActivityRepository;
import com.cqupt.wang.domain.activity.service.partake.BaseActivityPartake;
...
public class ActivityPartakeImpl extends BaseActivityPartake {
    ...
    protected Result grabActivity(PartakeReq partake, ActivityBillVO bill) {
        try {
            dbRouter.dbRouter(partake.getuId());//先确定数据库路由在执行事务操作
